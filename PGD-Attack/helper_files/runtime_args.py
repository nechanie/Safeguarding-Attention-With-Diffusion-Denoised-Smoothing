...
parser.add_argument('--epoch', type=int, help='Specify the number of epochs for the training.', default=30)
...
parser.add_argument('--num_workers', type=int, help='Specify the number of workers to be used to load the data.', default=2)
...
parser.add_argument('--PGD_epsilon', type=float, default= .01)
parser.add_argument('--PGD_stepsize', type=float, default= .01)
